...
class LoginForm(FlaskForm):
    ...
    def process_data(self):
        ...
        session['migrator'] = {'lkod': {'url': self.lkod_server_url.data, 'organizationId': self.user.organization_id, 'accessToken': self.user.access_token}, 'ckan': {'url': self.ckan_server_url.data, 'api_key': self.ckan_api_key.data}, 'vatin': self.company_vatin.data,}
